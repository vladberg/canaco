...
<?	
   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-10">
            <h2 style="color:#FE0000;padding-left: 150px">ADMINISTRADOR DE EXPOSITORES</h2>
          </div>
        </div>
		...
		<div class="row">
          <div class="col-lg-10">
            <div class="row">
  	          <div class="col-md-6"><h1>Patrocinadores</h1></div>
              <div class="col-md-6" align="right"><h2><a href="admin.si.expositores.php?opc=ADD&id=0" class="btn btn-success">Agregar Expositor</a></h2></div>
            </div>
            <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
							...
							$query="SELECT * FROM expositores order by nombre asc;";
                  ...
                  <input type="hidden" name="idcat[]" value="<?php echo $row['id_expositor'];?>">
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    <td><a href="admin.si.expositores.php?<? echo "id=".$row['id_expositor']."&opc=UPD"; ?>&rowId=row<? echo $icont; ?>"><img src="img/editar.gif" border="0"/><? echo $row['orden']; ?></a></td>

                    <td><a target="_blank" href="../expositores/<?php echo $row['imagen']?>" ><? echo html_entity_decode($row['nombre'], ENT_QUOTES); ?></a></td>
                    
                    <td><img border="0" src="img/<?php echo $imagen; ?>"  /></td>
                    <td><a href="eliminar_expositor.php?id=<?php echo $row['id_expositor']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><img src="img/delete.gif" border="0"  title="Eliminar Seccion"  style="cursor:pointer;"  /></a></td>
                  </tr>
                  <? }
              ...
              <? if(mysql_num_rows($resultado) <= 0){?>
         <h1 style="text-align:center;" class="danger">No hay Expositores capturadas por el momento</h1>
         <?php }?>
            </div>
          </div>
         </div>
