...
$user=$_SESSION['admin_user'];
	...
	if($opcion=='UPD'){
		...
		$query="SELECT nombre,imagen,estatus FROM expositores where id_expositor='$idreg' limit 1";
		...
		if($opcion=='SAVE'){
			...
			if(!empty($_FILES['filefoto']['name'])){
				...
				if($idreg!=0){
					...
					$tranx="update expositores set nombre='$titulo',estatus='$publicar'where id_expositor=$idreg";
          ...
          <div class="col-lg-8">
           ...
           <br/>
            ...
            <div class="row" >
             <div class="col-lg-8">
            <div class="row">
  	          <div class="col-md-6"><h2>Nuevo Expositor</h2></div>
              </div>
...
informaci&oacute;n. <a href="filtro_expositores.php" onClick="actualizarLista();">Ver lista 
...
informacion. Por favor Intenta de Nuevo.</div>
   ...
   <?php if($opcion=="UPD"){?>
    ...
    <div class="modal-footer">
                    <a href="filtro_expositores.php" onclick="return confirmar('¿Est&aacute; seguro que desea salir,no se guardara el registro?')"><button type="button" class="btn btn-default" data-dismiss="modal" >Cancelar</button></a>
