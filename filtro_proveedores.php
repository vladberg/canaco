...
<?	
   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-10">
           <h2 style="color:#FE0000;padding-left: 150px">ADMINISTRADOR DE MENSAJES</h2>
          </div>
        </div>
		...
		<div class="row">
          <div class="col-lg-10">
            <div class="row">
  	          <div class="col-md-6"><h1>Mensajes</h1></div>
              <div class="col-md-6" align="right"><h2><a href="admin.si.proveedores.php?opc=ADD&id=0" class="btn btn-success">Agregar Mensaje</a></h2></div>
            </div>
            <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
							...
							$query="SELECT * FROM mensaje order by id_mensaje asc;";
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    <td><a href="admin.si.proveedores.php?<? echo "id=".$row['id_mensaje']."&opc=UPD"; ?>&rowId=row<? echo $icont; ?>"><?php echo $row['id_mensaje'];?></a></td>
                    <td><? echo html_entity_decode($row['bienvenida'], ENT_QUOTES); ?></td>
                    <td><? echo html_entity_decode($row['pie'], ENT_QUOTES); ?></td>
