...
<?	
   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-10">
            <h2 style="color:#FE0000;padding-left: 150px">ADMINISTRADOR DE PATROCINADORES</h2>
          </div>
        </div>
		...
		<div class="row">
          <div class="col-lg-10">
            <div class="row">
              ...
              <div class="col-md-6" align="right"><h2><a href="admin.si.categorias.php?opc=ADD&id=0" class="btn btn-success">Agregar Patrocinador</a></h2></div>
            </div>
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    ...
                    <td><a href="../patrocinadores/<?php echo $row['imagen']?>" target="_blank"><? echo html_entity_decode($row['categoria'], ENT_QUOTES); ?></a></td>
                    
                    <td><img src="img/<?php echo $imagen; ?>" border="0" /></td>
